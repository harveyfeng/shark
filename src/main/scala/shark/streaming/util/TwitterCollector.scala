...
/**
 * Continuously samples tweets from Twitter and loads them into HDFS or S3.
 *
...
object TwitterCollector {
  def main(args: Array[String]) {
    ...
    // Includes both the field we want to get and the Hive column name and type
    ...
    // new twitter stream
    val statuses = ssc.twitterStream(None, Nil, StorageLevel.MEMORY_ONLY_SER)
